...
import StrokePalette from '../material/StrokePalette.js';
...
import ArrawLeft from 'material-ui/svg-icons/hardware/keyboard-arrow-left';
import ArrawRight from 'material-ui/svg-icons/hardware/keyboard-arrow-right';


class LineSymbolizer extends React.Component {
  ...
  constructor() {
    ...
    this.handleChangeStrokePalette = this.handleChangeStrokePalette.bind(this);
    this.handleChangeStrokeOpacity = this.handleChangeStrokeOpacity.bind(this);
    ...
    if (this.props.styles != null) {
      ...
      if (options != undefined) {
        ...
        this.setState({
          ...
          strokePalette: options.strokePalette != undefined ? options.strokePalette : StrokePalette.defaultProps.strokePalette ,
  ...
  handleChangeStrokePalette(event, index, value){
    this.setState({
      strokePalette:value
    })
  }

  handleChangeStrokeOpacity(event, index, value){
    this.setState({
      strokeOpacity:value
    })
  }
  ...
  editStyle(){
    ...
    if(this.state.symbolizerType == 'SINGLE'){
      ...
      let option = {
        ...
        strokeWidth: this.state.strokeWidth==null ? StrokeWidth.defaultProps.value : this.state.strokeWidth,
        strokePalette: this.state.strokePalette==null ? StrokePalette.defaultProps.strokePalette : this.state.strokePalette,
        strokeOpacity: this.state.strokeOpacity==null ? StrokePalette.defaultProps.strokeOpacity : this.state.strokeOpacity,
  ...
  render() {
    ...
    // outlineOpacity
      ...
      style = (
        <Paper zDepth={0} style={{fontSize:13}}>
          ...
          <StrokePalette
            strokePalette={this.state.strokePalette}
            strokeOpacity={this.state.strokeOpacity}
            handleChange={this.handleChangeStrokePalette}
            classesNumber={this.state.classesNumber}
            handleChangeStrokeOpacity={this.handleChangeStrokeOpacity}
          />
    ...
    return (
      <div style={{paddingTop:10,paddingLeft:10,paddingRight:10}}>
        ...
        <Paper zDepth={0} style={{padding:3,paddingBottom: 10,display:'flex',widht:100,overflowY:'auto',fontSize:12,height:135, marginLeft:15}}>
          {/* <Slider {...settings}> */}
          <Paper style={this.state.symbolizerType=='SINGLE'? styleStyle.selected : styleStyle.unSelected} onClick={()=>this.symbolizerTypeChange('SINGLE') }>
            <img src={contextPath+"/assets/images/symbol_line_simp.png"} style={{width:70,height:70}} alt="SINGLE"></img>
          ...
          <Paper style={this.state.symbolizerType=='GRADUATED'? styleStyle.selected : styleStyle.unSelected} onClick={()=>this.symbolizerTypeChange('GRADUATED') }>
            <img src={contextPath+'/assets/images/symbol_line_chor.png'} style={{width:70,height:70}} alt="GRADUATED"></img>
          ...
          <Paper style={this.state.symbolizerType=='CATEGORIES'? styleStyle.selected : styleStyle.unSelected} onClick={()=>this.symbolizerTypeChange('CATEGORIES') }>
            <img src={contextPath+'/assets/images/symbol_line_cate.png'} style={{width:70,height:70}} alt="CATEGORIES"></img>
