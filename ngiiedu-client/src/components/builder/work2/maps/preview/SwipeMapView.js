...
class SwipeMapView extends React.Component {
  ...
  addBaseLayer(map) {
    ...
    var ngiiURL     = apiSvr + '/ngiiemapProxy?ngiiproxy=http://map.ngii.go.kr/proxys//proxy/proxyTile.jsp?apikey=04trYP9_xwLAfALjwZ-B8g&URL=http://210.117.198.62:8081/2015_map/korean_map_tile';
